...
#	endif
#endif
#ifdef XYO_PLATFORM_COMPILE_STATIC
#	undef XYO_PLATFORM_LIBRARY_IMPORT
#	undef XYO_PLATFORM_LIBRARY_EXPORT
#	define XYO_PLATFORM_LIBRARY_EXPORT
#	define XYO_PLATFORM_LIBRARY_IMPORT
#endif
...
#ifdef XYO_PLATFORM_DLL_INTERNAL
#	define XYO_PLATFORM_EXPORT XYO_PLATFORM_LIBRARY_EXPORT
#else
#	define XYO_PLATFORM_EXPORT XYO_PLATFORM_LIBRARY_IMPORT
#endif
#ifdef XYO_PLATFORM_LIBRARY
#	undef XYO_PLATFORM_EXPORT
#	define XYO_PLATFORM_EXPORT
#endif
#ifdef XYO_PLATFORM_LIB_INTERNAL
#	undef XYO_PLATFORM_EXPORT
#	define XYO_PLATFORM_EXPORT
#endif
#ifdef XYO_PLATFORM_STATIC_LIB_INTERNAL
#	undef XYO_PLATFORM_EXPORT
#	define XYO_PLATFORM_EXPORT
#endif
